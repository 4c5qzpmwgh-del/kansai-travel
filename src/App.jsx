          ...
          {activeTab === 'budget' && (
             <div style={{ paddingBottom: '40px' }}>
              ...
              <div style={{ background: 'white', padding: '25px', borderRadius: theme.radius, boxShadow: theme.shadow, marginBottom: '25px' }}>
                ...
                <input placeholder="項目 (如: 燒肉、JR車票)" value={budgetItem} onChange={e => setBudgetItem(e.target.value)} style={inputStyle} /><input type="number" placeholder="金額 (台幣或日幣自己方面計算即可)" value={budgetAmount} onChange={e => setBudgetAmount(e.target.value)} style={inputStyle} />
